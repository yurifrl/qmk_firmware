 ...
 * MAC_BASE: Right Ctrl -> TG(L_FN1) (tap toggles layer).
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_61_ansi(
        ...
        MO(L_FN1),KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD,MO(MAC_FN),MO(L_FN1),TG(L_FN1)),
    ...
    [L_FN1] = LAYOUT_61_ansi(
        KC_QUOT,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,
